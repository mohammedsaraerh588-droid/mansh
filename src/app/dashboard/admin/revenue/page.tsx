  ...
  return (
    <div style={{display:'flex', flexDirection:'column', gap:22}}>
      <div>
        ...
        <h1 style={{fontSize:24,fontWeight:900,color:'var(--tx1)',letterSpacing:'-.02em'}}>الإيرادات والمبيعات</h1>
      </div>

      <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(200px,1fr))',gap:16}}>
        {[
          { label:'إجمالي الإيرادات', value:fmt(revenue),    Icon:DollarSign, color:'#E8F5E9', ic:'var(--alpha-green)' },
          { label:'إجمالي المبيعات',  value:count,           Icon:TrendingUp, color:'#E3F2FD', ic:'#1565C0' },
          { label:'متوسط قيمة البيع', value:count>0?fmt(revenue/count):'—', Icon:BarChart2, color:'#FFF8E1', ic:'#F57F17' },
      ...
      {topCourses.length > 0 && (
        <div className="card" style={{overflow:'hidden'}}>
          <div style={{padding:'16px 20px',borderBottom:'1px solid var(--brd)'}}>
            <h2 style={{fontSize:16,fontWeight:800,color:'var(--tx1)'}}>أعلى الدورات إيراداً</h2>
          </div>
          <table className="tbl">
